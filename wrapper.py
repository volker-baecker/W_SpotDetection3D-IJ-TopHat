...
def main(argv):
    ...
    with NeubiasJob.from_cli(argv) as nj:
        ...
        command = "/usr/bin/xvfb-run java -Xmx6000m -cp /fiji/jars/ij.jar ij.ImageJ --headless --console " \
                  "-macro macro.ijm \"input={}, output={}, filter_xy={},            filter_z={},            top_hat_xy={},            top_hat_z={},            dynamic={},            connectivity={}\"" \
                              .format(in_path,  out_path,  nj.parameters.filter_xy, nj.parameters.filter_z, nj.parameters.top_hat_xy, nj.parameters.top_hat_z, nj.parameters.dynamic, nj.parameters.connectivity)
